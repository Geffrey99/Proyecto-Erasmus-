...
<div class="columna">   
    ...
    <input type="text" id="dni_Candidato" class="input_cs" name="dni_Candidato" maxlength="9" placeholder="77777777X"><br>
    ...
    <input type="text" id="nombre_Candidato" class="input_cs" name="nombre_Candidato" maxlength="50" placeholder="Domingo"><br>
    <span id="error_nombre" style="color: red;"></span>
    
    <label for="ap1_Candidato">Primer Apellido:</label><br>
    <input type="text" id="ap1_Candidato" class="input_cs" name="ap1_Candidato" maxlength="50" placeholder="Domingero"><br>
    <span id="error_ap1" style="color: red;"></span>
    
    <label for="ap2_Candidato">Segundo Apellido:</label><br>
    <input type="text" id="ap2_Candidato" class="input_cs" name="ap2_Candidato" maxlength="50" placeholder="DomingoS"><br>
    <span id="error_ap2" style="color: red;"></span>
</div>

<div class="columna">
    <label for="telefono_Candidato">Teléfono:</label><br>
    <input type="text" id="telefono_Candidato" class="input_cs" name="telefono_Candidato" maxlength="9" placeholder="654000123"><br>
    <span id="error_telefono" style="color: red;"></span>

    <label for="correo_Candidato">Correo:</label><br>
    <input type="email" id="correo_Candidato" class="input_cs" name="correo_Candidato" maxlength="50" placeholder="geff@gmail.xx"><br>
    <span id="error_correo" style="color: red;"></span>

    <label for="domicilio_Candidato">Domicilio:</label><br>
    <input type="text" id="domicilio_Candidato" class="input_cs" name="domicilio_Candidato" maxlength="50" placeholder="Calle los domingosa"><br>
    ...
    <input type="password" id="password" class="input_cs" name="password" maxlength="30" placeholder="NOTEOLVIDES.."><br>
    <span id="error_password" style="color: red;"></span>
    
<!--#############____MODAL TUTOR LEGAL SI ES MENOR EL CANDIDATO___######---------------------->
    ...
    <div class="modal-content">
     <span class="close">&times;</span>   
        ...
        <legend>TUTOR LEGAL</legend>
            ...
            <input type="text" id="dni_TutorLegal" class="input_csmodal" name="dni_TutorLegal" maxlength="9" placeholder="777777777Y"><br>
            <span id="error_dni_tutor" class="inputError" style="color: red;"></span>
            
            <label for="nombre_TutorLegal">Nombre:</label><br>
            <input type="text" id="nombre_TutorLegal" class="input_csmodal" name="nombre_TutorLegal" maxlength="20" placeholder="TU PADRE O TU MADRE"><br>
            <span id="error_nombre_tutor" class="inputError" style="color: red;"></span>
            
            <label for="apellido_TutorLegal">Primer Apellido:</label><br>
            <input type="text" id="apellido_TutorLegal" class="input_csmodal" name="apellido_TutorLegal" maxlength="20" placeholder="DOMINGO"><br>
            <span id="error_apellido_tutor" class="inputError" style="color: red;"></span>
            
            <label for="telefono_TutorLegal">Teléfono:</label><br>
            <input type="text" id="telefono_TutorLegal" class="input_csmodal" name="telefono_TutorLegal" maxlength="9" placeholder="678910000"><br>
            <span id="error_telefono_tutor" class="inputError" style="color: red;"></span>
            
            <label for="domicilio_TutorLegal">Domicilio:</label><br>
            <input type="text" id="domicilio_TutorLegal" class="input_csmodal" name="domicilio_TutorLegal" maxlength="50" placeholder="Avenida Madrid Jaen jaen 9 9"><br> 
