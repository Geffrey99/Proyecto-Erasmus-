...
<div id="login-container">
    <div id="login-form">
        <h2>Iniciar sesión - Candidato</h2>
  
        <form action="./api/verificarlogueos.php"  method="post">
            <div>
                <label for="dni_Candidato">DNI:</label>
                <input type="text" class="dni" id="dni_Candidato" name="dni_Candidato" required>
            </div>
            <div>
            ...
            <div class="button-container">
                <input type="submit" name="form_candidato" value="Iniciar sesión">
            </div>
        </form>
